...
//   CREATE INDEX idx_message_logs_queue ON td_message_logs(queue_id)
//   CREATE UNIQUE INDEX idx_logs_provider_msg_id ON td_message_logs(provider_msg_id);
//   CREATE INDEX idx_logs_status ON td_message_logs(status);
